...
public class Fragment_Bakery_Wholesale extends Fragment {
LinearLayout linearLayout;
    Toolbar toolbar;
    TextView text_visible;
    ImageView logo_visible;
    public Fragment_Bakery_Wholesale() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_bakery_wholesale, container, false);
        linearLayout=(LinearLayout) view.findViewById(R.id.layout);
        tool_set();
        linearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RamConstants.buttonclick=5;
    ...
    void tool_set(){
        ...
        text_visible.setText("Bakery Wholesale");
    }
}
