...
public class News_Letter_Fragment extends Fragment {
    Toolbar toolbar;
    TextView text_visible;
    ImageView logo_visible;
    public News_Letter_Fragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.newsletter_subscription_fragment, container, false);
    ...
    void tool_set(){
        ...
        text_visible.setText("News Letter ....");
    }
}
