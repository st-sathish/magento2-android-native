...
public class Fragment_BeveragesWholesale extends Fragment {
LinearLayout linearLayout;
    Toolbar toolbar;
    TextView text_visible;
    ImageView logo_visible;
    public Fragment_BeveragesWholesale() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_beverages_wholesale, container, false);
    ...
    void tool_set(){
        ...
        text_visible.setText("Beverages Wholesale");
    }
}
