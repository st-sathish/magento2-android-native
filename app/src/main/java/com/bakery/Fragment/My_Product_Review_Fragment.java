...
public class My_Product_Review_Fragment extends Fragment {
    LinearLayout new_address_button;
    Toolbar toolbar;
    TextView text_visible;
    ImageView logo_visible;
    public My_Product_Review_Fragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.my_product_review_fragment, container, false);
    ...
    void tool_set(){
        ...
        text_visible.setText("My Product Review");
    }
}