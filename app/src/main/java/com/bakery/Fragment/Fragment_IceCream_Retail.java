...
public class Fragment_IceCream_Retail extends Fragment {
LinearLayout linearLayout;
    Toolbar toolbar;
    TextView text_visible;
    ImageView logo_visible;
    public Fragment_IceCream_Retail() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_ice_cream_retail, container, false);
    ...
    void tool_set(){
        ...
        text_visible.setText("IceCream Retail");
    }
}
