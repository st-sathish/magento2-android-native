...
public class Store_Payment_Method_Fragment extends Fragment {
    Toolbar toolbar;
    TextView text_visible;
    ImageView logo_visible;
    public Store_Payment_Method_Fragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.store_payment_fragment, container, false);
    ...
    void tool_set(){
        ...
        text_visible.setText("Store Payment ...");
    }
}
