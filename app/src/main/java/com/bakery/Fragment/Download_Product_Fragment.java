...
public class Download_Product_Fragment extends Fragment {
    Toolbar toolbar;
    TextView text_visible;
    ImageView logo_visible;
    public Download_Product_Fragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.my_download_product_fragment, container, false);
    ...
    void tool_set(){
        ...
        text_visible.setText("My Downloadable ..");
    }
}