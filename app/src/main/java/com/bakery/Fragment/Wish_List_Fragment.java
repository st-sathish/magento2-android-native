...
public class Wish_List_Fragment extends Fragment {
    LinearLayout new_address_button;
    Toolbar toolbar;
    TextView text_visible;
    ImageView logo_visible;
    public Wish_List_Fragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.my_wish_list_fragment, container, false);
    ...
    void tool_set(){
        ...
        text_visible.setText("My Wish List");
    }
}
